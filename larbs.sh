#!/bin/sh
# Luke's Auto Rice Boostrapping Script (LARBS), rakete-edition
# by Luke Smith <luke@lukesmith.xyz>, rakete <rakete@rakete.xyz>, and contributors
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/quadcerebrumal/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/quadcerebrumal/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "This is LARBS with some changes to suit my taste.\\n\\n-rakete" 10 60
